...
//DOM - Document Object Model (Îáúåêòíàÿ ìîäåëü äîêóìåíòà).
...
tick_timer();
function tick_timer() {
	let time = new Date();	//Ñîçäàåòñÿ îáúåêò êëàññà 'Date'. Îáúåêòû êëàññà 'Date' õðàíÿò èíôîðìàöèþ î äàòå, âðåìåíè è ÷àñîâîì ïîÿñå.
	...
	setTimeout(tick_timer, 100);	//Ôóíêöèÿ setTimeout() âûçûâàåò äðóãóþ ôóíêöèþ ÷åðåç óêàçàííûé ïðîìåæóòîê âðåìåíè (10ms);
}